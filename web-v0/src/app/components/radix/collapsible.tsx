...
function Bio() {
  ...
  return (
    <h2>
      ...
      <br></br>
      <br></br>
    While this website is <div style={{ textDecoration: 'underline', display: 'inline'}}>under renovation</div>, you can access his <em><a href="https://www.linkedin.com/in/krisaziabor/">Linkedin</a></em>, <em><a href="https://read.cv/krisaziabor">CV</a></em>, and <em><a href="https://github.com/krisaziabor/">Github</a></em>, and this portfolio&apos;s <em>Colophon</em>.
    </h2>
  );
}
